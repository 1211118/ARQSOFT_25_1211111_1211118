...
public class Bootstrapper implements CommandLineRunner {
    ...
    @Autowired
    private LendingFactory lendingFactory;  // Injeção da fábrica
    @Autowired
    private AuthorFactory authorFactory;  // Injeção da fábrica
    ...
    private void createAuthors() {
        if (authorRepository.searchByNameName("Manuel Antonio Pina").isEmpty()) {
            final Author author = authorFactory.createAuthor("Manuel Antonio Pina",
                    "Manuel António Pina foi um jornalista e escritor português, premiado em 2011 com o Prémio Camões",
                    null);
            authorRepository.save(author);
        }
        if (authorRepository.searchByNameName("Antoine de Saint Exupéry").isEmpty()) {
            final Author author = authorFactory.createAuthor("Antoine de Saint Exupéry",
        ...
        if (authorRepository.searchByNameName("Alexandre Pereira").isEmpty()) {
            final Author author = authorFactory.createAuthor("Alexandre Pereira",
        ...
        if (authorRepository.searchByNameName("Filipe Portela").isEmpty()) {
            final Author author = authorFactory.createAuthor("Filipe Portela",
        ...
        if (authorRepository.searchByNameName("Ricardo Queirós").isEmpty()) {
            final Author author = authorFactory.createAuthor("Ricardo Queirós",
        ...
        if (authorRepository.searchByNameName("Freida Mcfadden").isEmpty()) {
            final Author author = authorFactory.createAuthor("Freida Mcfadden",
        ...
        if (authorRepository.searchByNameName("J R R Tolkien").isEmpty()) {
            final Author author = authorFactory.createAuthor("J R R Tolkien",
        ...
        if (authorRepository.searchByNameName("Gardner Dozois").isEmpty()) {
            final Author author = authorFactory.createAuthor("Gardner Dozois",
        ...
        if (authorRepository.searchByNameName("Lisa Tuttle").isEmpty()) {
            final Author author = authorFactory.createAuthor("Lisa Tuttle",
    ...
    private void createLendings() {
        ...
        for(i = 0; i < 3; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(i), readers.get(i * 2), 2024, seq, startDate, returnedDate, lendingDurationInDays, fineValuePerDayInCents);
        ...
        for(i = 0; i < 3; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(1 + i), readers.get(1 + i * 2), 2024, seq, startDate, null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for(i = 0; i < 3; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(3 / (i + 1)), readers.get(i * 2), 2024, seq, startDate, null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for(i = 0; i < 3; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(3 - i), readers.get(1 + i * 2), 2024, seq, startDate, returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for(i = 0; i < 6; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(i), readers.get(i), 2024, seq, startDate, returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for(i = 0; i < 6; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(i), readers.get(1 + i % 4), 2024, seq, startDate, returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for(i = 0; i < 6; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(i), readers.get(i % 2 + 2), 2024, seq, startDate, returnedDate, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for(i = 0; i < 6; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(i), readers.get(i % 2 + 3), 2024, seq, startDate, null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
        ...
        for(i = 0; i < 10; i++){
            ...
            if(lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()){
                ...
                lending = lendingFactory.createBootstrappingLending(books.get(i), readers.get(4 - i % 4), 2024, seq, startDate, null, lendingDurationInDays, fineValuePerDayInCents);
                lendingRepository.save(lending);
            }
        }
    }
