...
public class Bootstrapper implements CommandLineRunner {
    ...
    public Bootstrapper( PhotoRepository photoRepository, ForbiddenNameService forbiddenNameService) {
    ...
    private void createGenres() {
        if (genreRepository.findByString("Fantasia").isEmpty()) {
            ...
            var genre = genreRepository.findByString("Fantasia");
    ...
    protected void createBooks() {
        ...
        if(bookRepository.findByIsbn("9789720706386").isEmpty()) {
            ...
            System.out.println("Creating book O País das Pessoas de Pernas Para o Ar");
        ...
        if(bookRepository.findByIsbn("9789723716160").isEmpty()) {
            ...
            System.out.println("Creating book Como se Desenha Uma Casa");
        ...
        if(bookRepository.findByIsbn("9789895612864").isEmpty()) {
            ...
            System.out.println("Creating book C e Algoritmos");
        ...
        if(bookRepository.findByIsbn("9782722203402").isEmpty()) {
            ...
            System.out.println("Creating book Introdução ao Desenvolvimento Moderno para a Web");
        ...
        if(bookRepository.findByIsbn("9789722328296").isEmpty()) {
            ...
            System.out.println("Creating book O Principezinho");
        ...
        if(bookRepository.findByIsbn("9789895702756").isEmpty()) {
            ...
            System.out.println("Creating book A Criada Está a Ver");
        ...
        if(bookRepository.findByIsbn("9789897776090").isEmpty()) {
            ...
            System.out.println("Creating book O Hobbit");
        ...
        if(bookRepository.findByIsbn("9789896379636").isEmpty()) {
            ...
            System.out.println("Creating book Histórias de Vigaristas e Canalhas");
        ...
        if(bookRepository.findByIsbn("9789896378905").isEmpty()) {
            ...
            System.out.println("Creating book Histórias de Aventureiros e Patifes");
            List<Author> authors = new ArrayList<>();
            genre = Optional.ofNullable(genreRepository.findByString("Fantasia"))
                    .orElseThrow(() -> new NotFoundException("Cannot find genre"));
            author = authorRepository.searchByNameName("J R R Tolkien");
        ...
        if(bookRepository.findByIsbn("9789896375225").isEmpty()) {
            ...
            System.out.println("Creating book Windhaven");
    ...
    private void createLendings() {
        ...
        Optional<Book> book1 = bookRepository.findByIsbn("9789720706386");
        Optional<Book> book2 = bookRepository.findByIsbn("9789723716160");
        Optional<Book> book3 = bookRepository.findByIsbn("9789895612864");
        Optional<Book> book4 = bookRepository.findByIsbn("9782722203402");
        Optional<Book> book5 = bookRepository.findByIsbn("9789722328296");
        Optional<Book> book6 = bookRepository.findByIsbn("9789895702756");
        Optional<Book> book7 = bookRepository.findByIsbn("9789897776090");
        Optional<Book> book8 = bookRepository.findByIsbn("9789896379636");
        Optional<Book> book9 = bookRepository.findByIsbn("9789896378905");
        Optional<Book> book10 = bookRepository.findByIsbn("9789896375225");
    
        if (book1.isPresent()) books.add(book1.get());
        if (book2.isPresent()) books.add(book2.get());
        if (book3.isPresent()) books.add(book3.get());
        if (book4.isPresent()) books.add(book4.get());
        if (book5.isPresent()) books.add(book5.get());
        if (book6.isPresent()) books.add(book6.get());
        if (book7.isPresent()) books.add(book7.get());
        if (book8.isPresent()) books.add(book8.get());
        if (book9.isPresent()) books.add(book9.get());
        if (book10.isPresent()) books.add(book10.get());
    
        if (books.size() < 10) {
            System.out.println("Erro: Nem todos os livros esperados foram encontrados no banco de dados.");
            System.out.println("books.size() = " + books.size());
            
            return;
        }
    
        // Populando a lista de leitores
        Optional<ReaderDetails> reader1 = readerRepository.findByReaderNumber("2024/1");
        Optional<ReaderDetails> reader2 = readerRepository.findByReaderNumber("2024/2");
        Optional<ReaderDetails> reader3 = readerRepository.findByReaderNumber("2024/3");
        Optional<ReaderDetails> reader4 = readerRepository.findByReaderNumber("2024/4");
        Optional<ReaderDetails> reader5 = readerRepository.findByReaderNumber("2024/5");
        Optional<ReaderDetails> reader6 = readerRepository.findByReaderNumber("2024/6");
    
        if (reader1.isPresent()) readers.add(reader1.get());
        if (reader2.isPresent()) readers.add(reader2.get());
        if (reader3.isPresent()) readers.add(reader3.get());
        if (reader4.isPresent()) readers.add(reader4.get());
        if (reader5.isPresent()) readers.add(reader5.get());
        if (reader6.isPresent()) readers.add(reader6.get());
    
        if (readers.size() < 6) {
            System.out.println("Erro: Nem todos os leitores esperados foram encontrados no banco de dados.");
            return;
        }
        ...
        // Lendings 1 a 3 (atrasados, devolvidos)
        for (int i = 0; i < 3; i++) {
            ++seq;
        ...
        // Lendings 4 a 6 (atrasados, não devolvidos)
        for (int i = 0; i < 3; i++) {
            ++seq;
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
        ...
        // Lendings 7 a 9 (atrasados, não devolvidos)
        for (int i = 0; i < 3; i++) {
            ++seq;
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
        ...
        // Lendings 30 a 35 (não devolvidos, não atrasados)
        for (int i = 0; i < 6; i++) {
            ++seq;
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
        ...
        // Lendings 36 a 45 (não devolvidos, não atrasados)
        for (int i = 0; i < 10; i++) {
            ++seq;
            if (lendingRepository.findByLendingNumber("2024/" + seq).isEmpty()) {
  ...
  /*  private void createPhotos() {
        ...
        if(photoJoao.isEmpty()) {
            Photo photo = new Photo(Path.get(""))
        }
    }*/
}
